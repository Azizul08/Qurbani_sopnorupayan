                        ...
                        <table align="center" cellpadding="0" cellspacing="0" border="0" style="width:100%;max-width:600px;border: 1px solid #d3d3d3;">
                            ...
                            <tr>
                                <td>
                                  ...
                                  <tr>
                                                <td class="heroSubTitle" align="center" valign="middle" style="font-family:'Lato', sans-serif;color:#96588a;font-size:12px;line-height:20px;font-weight:600;letter-spacing:0px;padding:0;padding-bottom:15px; text-align: left;">Order Id:  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; {{$orderId}}  </td>
                                            </tr>
                                            
                                             <tr>
                                                <td class="heroSubTitle" align="center" valign="middle" style="font-family:'Lato', sans-serif;color:#96588a;font-size:12px;line-height:20px;font-weight:600;letter-spacing:0px;padding:0;padding-bottom:15px; text-align: left;">ProductName:  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; {{$productName}}  </td>
                                            </tr> 
                                        <tr>
                                        <td class="heroSubTitle" align="center" valign="middle" style="font-family:'Lato', sans-serif;color:#96588a;font-size:12px;line-height:20px;font-weight:600;letter-spacing:0px;padding:0;padding-bottom:15px; text-align: left;">ProductPrice:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;{{$productPrice}} </td>
                                            </tr> 
                                            <!-- <tr>
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                <td class="heroSubTitle" align="center" valign="middle" style="font-family:'Lato', sans-serif;color:#37393d;font-size:12px;line-height:10px;font-weight:400;letter-spacing:0px;padding:0;padding-bottom:15px; text-align: left;">
                                                   <span style="font-weight: bold;"> </span>Name : {{$firstname}} {{$lastname}}
                                                </td>
                                            </tr>

                                            <tr>
                                    <td class="heroSubTitle" align="center" valign="middle" style="font-family:'Lato', sans-serif;color:#37393d;font-size:12px;line-height:10px;font-weight:400;letter-spacing:0px;padding:0;padding-bottom:15px; text-align: left;">
                                       <span style="font-weight: bold;"> </span>  Address : {{$address}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="heroSubTitle" align="center" valign="middle" style="font-family:'Lato', sans-serif;color:#37393d;font-size:12px;line-height:10px;font-weight:400;letter-spacing:0px;padding:0;padding-bottom:15px; text-align: left;">
                                       <span style="font-weight: bold;"> </span>  Phone : {{$phone}}
                                    </td>
                                </tr>
