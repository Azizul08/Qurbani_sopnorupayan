	...
	<div class="contact">
		<div class="container">
			<div class="contact-grids">
				<div class="col-md-4 contact-grid text-center animated wow slideInLeft" data-wow-delay=".5s">
					<div class="contact-grid1">
						...
						<h4>Address</h4>
						<p> Road:34, Ta block,Section-6,Mirpur <span>Dhaka.</span></p>
					</div>
				</div>
				<div class="col-md-4 contact-grid text-center animated wow slideInUp" data-wow-delay=".5s">
					<div class="contact-grid2">
						...
						<h4>Call Us</h4>
						<p>+8801751383947<span>+8801521122009</span></p>
					</div>
				</div>
				<div class="col-md-4 contact-grid text-center animated wow slideInRight" data-wow-delay=".5s">
					<div class="contact-grid3">
						...
						<h4>Email</h4>
						<p><a href="mailto:ruhul@sopnorupayan.com">ruhul@sopnorupayan.com</a><span><a href="mailto:m.azizulcse@gmail.com">m.azizulcse@gmail.com</a></span></p>
					</div>
				</div>
			...
			<div class="map wow fadeInDown animated" data-wow-delay=".5s">
				...
				<iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d3650.2608640203207!2d90.3583673!3d23.8093211!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1587408608968!5m2!1sen!2sbd" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
