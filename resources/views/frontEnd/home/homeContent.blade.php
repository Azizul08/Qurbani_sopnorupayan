    ...
    <div id="visual">
        <div class="slide-visual">
            ...
            <ul class="slide-group">
                <li><img class="img-responsive" src="{{ asset('public/frontEnd/images/ba11.jpg') }}" alt="Dummy Image" /></li>
                <li><img class="img-responsive" src="{{ asset('public/frontEnd/images/ba22.jpg') }}" alt="Dummy Image" /></li>
                <li><img class="img-responsive" src="{{ asset('public/frontEnd/images/ba33.jpg') }}" alt="Dummy Image" /></li>
            </ul>

            <!-- Slide Description Image Area (316 x 328) -->
            <div class="script-wrap">
                <ul class="script-group">
                    <li><div class="inner-script"><img class="img-responsive" src="{{ asset('public/frontEnd/images/baa11.jpg') }}" alt="Dummy Image" /></div></li>
                    <li><div class="inner-script"><img class="img-responsive" src="{{ asset('public/frontEnd/images/baa22.jpg') }}" alt="Dummy Image" /></div></li>
                    <li><div class="inner-script"><img class="img-responsive" src="{{ asset('public/frontEnd/images/baa33.jpg') }}" alt="Dummy Image" /></div></li>
                </ul>
                        ...
                        <div class="col-md-3 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                ...
                                <div class="item-info-product ">
                                    ...
                                    <a href="{{ url('/product-details/'.$publishedProduct->id) }}" class="item_add single-item hvr-outline-out button2">Details</a>									
