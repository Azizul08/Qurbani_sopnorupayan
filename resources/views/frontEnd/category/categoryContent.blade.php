...
<div class="men-wear">
    <div class="container">
        ...
        <div class="col-md-8 products-right">
            ...
            <div class="men-wear-bottom">
                <div class="col-sm-4 men-wear-left">
                    <img class="img-responsive" src="{{ asset('public/frontEnd/') }}/images/men4.jpg" alt=" " />
                </div>
                <div class="col-sm-8 men-wear-right">
                    <h4>Exclusive Men's Collections</h4>
                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem 
        ...
        @elseif($publishedCategory->id == 12)
        ...
        <div class="col-md-8 products-right">
            ...
            <div class="men-wear-bottom">
                <div class="col-sm-4 men-wear-left">
                    <img class="img-responsive" src="{{ asset('public/frontEnd/') }}/images/men32.jpg" alt=" " />
                </div>
                <div class="col-sm-8 men-wear-right">
                    <h4>Exclusive Women's Collections</h4>
                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem 
        ...
        <p> Eid-ul-Adha / Cow, Goat & Bazar / Qurbani Cow & Goat</p>
